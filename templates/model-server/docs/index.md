...
- [ibm-granite/granite-3.3-8b-instruct](https://huggingface.co/ibm-granite/granite-3.3-8b-instruct) model served by a [vLLM](https://github.com/redhat-developer/rhdh-ai-developer-images/tree/main/model-servers/vllm/0.8.4) inference server.
